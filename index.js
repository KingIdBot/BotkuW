...
conn.sendMessage(id, 'Owner XBOT wa.me/+1 (831) 353-5216' ,MessageType.text);
}
else if (text == 'BOT'){
conn.sendMessage(id, 'Aku BOT nya Mℛ ᭄B O O Tツ' ,MessageType.text);
}
else if (text == 'audio'){
...
conn.sendMessage(id, '*⚠️KATA KASAR TERDETEKSI!'* ,MessageType.text);
}
else if (text == 'Anjing'){
